...
2. Installing the aac2txt Package

A. Change to the directory that contains the file setup.py and the subdirectory aac2txt. 
...
The aac2txt package is on your Python path. To import it into a Python script or session, 
execute:
